...
<Steps>
  ...
  <Step title="Add WhatsApp">
    Click **Connect Channel > WhatsApp**.
  </Step>
...
<Steps>
  ...
  <Step title="Add Telegram Channel">
    In your agent's **Channels** tab, click **Connect Channel > Telegram**.
  </Step>
...
<Steps>
  ...
  <Step title="Connect in Havoc">
    In your agent's **Channels** tab, click **Connect Channel > Discord** and paste the bot token.
  </Step>
</Steps>
...
| **Mattermost** | Plugin installation in your Mattermost server |
| **MS Teams** | Plugin installation via the Havoc MS Teams plugin |
| **LINE** | Channel access token from LINE Developers |
